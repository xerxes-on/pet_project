        ...
        <section class="profile-card">
            <div class="profile-header">
                <div class="flex w-2/3">
                    <img src="./assets/images/profile.png" alt="User Name" class="profile-avatar">
                    <div class="profile-info">
                        <h2>User Name</h2>
                        <div class="profile-stats">
                            <div class="stat"><span>100</span> Books</div>
                            <div class="stat"><span>1,245</span> Friend's</div>
                            <div class="stat"><span>8</span> Following</div>
                        </div>
                        <p class="text-xl">Details</p>
                        <p>Joined in Month DD YEAR</p>
                        <p><span class="text-blue block">Favorite  GENRES:</span> Romance, Mystery/Thriller, Fantasy,
                            Science Fiction, +5 More</p>
                    </div>
                </div>
            ...
            <div class="profile-details flex">
                <div>
                    <p class="m-5">Male, City, Country</p>
                    <p class="m-5"><i class="fas fa-birthday-cake"></i> Birth Day : DD/MM/YYYY</p>
                </div>
